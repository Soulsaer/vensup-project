...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset(env('ADMIN_ASSETS_URL') . 'assets/admin/libs/owl.carousel/assets/owl.carousel.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset(env('ADMIN_ASSETS_URL') . 'assets/admin/libs/owl.carousel/assets/owl.theme.default.min.css') }}">
    <link href="{{ asset(env('ADMIN_ASSETS_URL') . 'assets/admin/css/bootstrap.min.css') }}" id="bootstrap-style"
        rel="stylesheet" type="text/css" />
    <link href="{{ asset(env('ADMIN_ASSETS_URL') . 'assets/admin/css/icons.min.css') }}" rel="stylesheet" type="text/css" />
...
<body class="auth-body-bg">
    ...
    <script src="{{ asset(env('ADMIN_ASSETS_URL') . 'assets/admin/libs/owl.carousel/owl.carousel.min.js') }}"></script>
    <script src="{{ asset(env('ADMIN_ASSETS_URL') . 'assets/admin/js/pages/auth-2-carousel.init.js') }}"></script>
